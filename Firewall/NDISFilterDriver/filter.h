...
#define FILTER_FRIENDLY_NAME        L"NDISFilterDriver NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{d9cc6458-c8cc-432d-bcad-86b492189efb}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"NDISFilterDriver"
